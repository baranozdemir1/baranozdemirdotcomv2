    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://avatars.githubusercontent.com/u/35881298"
              alt="Avatar"
              width={96}
              height={96}
              quality={95}
      ...
      >
        <span className="font-bold">Hello, I&apos;m Baran.</span> I&apos;m a{" "}
      ...
      >
        ...
        <Link
          ...
          href="/baran-ozdemir-resume.pdf"
        >
          View Resume{" "}
          <HiDownload className="opactity-60 group-hover:translate-y-1 transition" />
        </Link>
        <div className="flex items-center justify-center gap-2">
          <Link
            ...
            href="https://linkedin.com/in/baranozdemir"
            target="_blank"
          >
            <BsLinkedin />
          </Link>
